...
public class ContractController {
    ...
    public String getRequest(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("maritalStatuses", Client.MaritalStatus.values());
    ...
    public String signContract(@PathVariable Long contractId) {
        contractRepository.setStatusOfContractById(contractId, String.valueOf(Contract.Status.SIGNED));
